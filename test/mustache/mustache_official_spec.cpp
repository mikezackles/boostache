...
std::string print_ast(std::string const & filename)
{
   ...
   map_t data = {
      {"comments_Inline.input" , map_t{}},
      {"comments_Multiline.input", map_t{}},
      {"comments_Standalone.input", map_t{}},
      {"comments_Indented_Standalone.input", map_t{}},
      {"comments_Standalone_Line_Endings.input", map_t{}},
      {"comments_Standalone_Without_Previous_Line.input", map_t{}},
      {"comments_Standalone_Without_Newline.input", map_t{}},
      {"comments_Multiline_Standalone.input", map_t{}},
      {"comments_Indented_Multiline_Standalone.input", map_t{}},
      {"comments_Indented_Inline.input", map_t{}},
      {"comments_Surrounding_Whitespace.input", map_t{}}
   };
   //map_t data = {
   ...
   boostache::generate(stream, templ, data[filename]);
   return stream.str();
}


std::string test_dir = "mustache/official_spec_dir";
